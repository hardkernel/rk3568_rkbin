...
## rk3308_bl32_v2.10.bin

| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-04-29 | rk3308_bl32_v2.10.bin | 5f256dc1a    | important |
...
| 3     | important | Enable CE instruction set by default                     | Algorithm runs slow without CE support                       | 6343517      |
| 4     | important | Fix the low-probability data abort issue                 | The reboot of the device during secure storage may trigger it with a low probability | -            |
