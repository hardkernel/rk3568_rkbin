...
## rk3566_ddr_1056MHz_ultra_v1.26.bin

| Date       | File                               | Build commit | Severity  |
| ---------- | ---------------------------------- | ------------ | --------- |
| 2025-05-26 | rk3566_ddr_1056MHz_ultra_v1.26.bin | 1e5d6e92ad   | important |

### New

1. Optimize the training process.
2. Adjust the CKE/CA related timing for better stability.

### Fixed

| Index | Severity  | Update                                                                       | Issue description               | Issue source |
| ----- | --------- | ---------------------------------------------------------------------------- | ------------------------------- | ------------ |
| 1     | important | Fix the issue of abnormal CS1 data during ultra wake-up.                     | Abnormal wake-up data           | -            |
| 2     | important | Fix the bug of abnormal startup probability.                                 | Capacity detection error.       | -            |
| 3     | important | Fix the issue where larger tdqs2dq drams cause the ddr bin to report errors. | Enhance software compatibility. | -            |
